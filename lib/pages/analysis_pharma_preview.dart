...
class _AnalysisPharmaPreviewState extends State<AnalysisPharmaPreview> {
  ...
  Timer? _retryTimer;
  final String serverUrl = "https://concord-fountain-getting-afterwards.trycloudflare.com";
...
Future<void> _checkServer() async {
  const serverUrl = "https://concord-fountain-getting-afterwards.trycloudflare.com"; // ✅ Cloudflare Tunnel
