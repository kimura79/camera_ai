...
class _AnalysisPharmaPreviewState extends State<AnalysisPharmaPreview> {
  ...
  Timer? _retryTimer;
  final String serverUrl = "https://tales-tour-challenged-gmt.trycloudflare.com";
...
Future<void> _checkServer() async {
  const serverUrl = "https://tales-tour-challenged-gmt.trycloudflare.com"; // ✅ Cloudflare Tunnel
