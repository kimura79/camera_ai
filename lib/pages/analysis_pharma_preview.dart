...
class _AnalysisPharmaPreviewState extends State<AnalysisPharmaPreview> {
  ...
  Timer? _retryTimer;
  final String serverUrl = "https://defines-restored-moderate-classes.trycloudflare.com";
...
Future<void> _checkServer() async {
  const serverUrl = "https://defines-restored-moderate-classes.trycloudflare.com"; // ✅ Cloudflare Tunnel
